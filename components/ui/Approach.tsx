      ...
      >
        <Card
          ...
          description="We'll collaborate to map out your
                  ...
                  We'll discuss things like site structure, navigation, and content
                  requirements."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="This is where the magic happens! 
                Based on the approved design, I'll translate everything 
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        duration-200 w-full  mx-auto flex
